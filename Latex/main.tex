...
\selectfont
\Huge
Wybrane aspekty techniczne odwzorowania artystycznej wizji jako trójwymiarowego œrodowiska w grze komputerowej
\end{center}
\begin{center}
\fontfamily{ptm}
\selectfont
...
Specjalnoœæ: Technologie gier i symulacji komputerowych
\end{tabular}
\end{center}
\vspace{-.5cm}
\begin{center}
...
\include{02_possible_optimalizations}
\include{03_procsess_description}
\include{04_procsess_implementation}
