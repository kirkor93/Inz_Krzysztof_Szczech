...
\end{figure}
\section{Atlasowanie}
Atlasowanie jest procesem maj¹cym na celu zebranie wielu niekoniecznie powi¹zanych ze sob¹ assetów w jedn¹ ca³oœæ oraz przechowywanie ich w jednym, du¿ym pliku.  \newline 

Mimo pewnych problemów, jakie niesie za sob¹ stosowanie tej techniki podczas pracy, wielu twórców stosuje j¹ w swoich projektach.

DLACZEGO: Pamiêæ, batchowanie, czasy ³adowania, ³atwiejszy dostêp do wielu tekstur jednoczeœnie\newline
RODZAJE: tekstur i modeli\newline
