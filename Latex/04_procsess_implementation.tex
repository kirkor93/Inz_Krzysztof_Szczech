...
\begin{itemize}
	...
	Innym efektem, który wartu tu wspomnieæ jest postprocessing sceny. Efekty, takie jak rozmycie (blur), czy okluzja otoczenia (ambient oclussion) pozwalaj¹ na poprawiæ finalny efekt. Nale¿y jednak pamiêtaæ, ¿e ich wykorzystywanie czasami znacznie zwiêksza zapotrzebowanie na zasoby komputera podczas renderowania sceny.\newline
	...
	W pracy wykorzystano ¿ó³tawe oœwietlenie, które dobrze oddaje klimat pomieszczeñ oœwietlanych przy pomocy otwartego ognia. Dodatkowo - zastosowanie niewielkiej intensywnoœci jeszcze bardziej wzmacnia ten efekt. Porównanie poziomu z ustawionym w scenie i wypieczonym przez silnik oœwietleniem mo¿na zobaczyæ na rysunku 4.7.
	\begin{figure}[!ht]
		\centering
